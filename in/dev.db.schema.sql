...
CREATE TABLE "mae_pages_richtextpage" (
    "page_ptr_id" integer NOT NULL PRIMARY KEY REFERENCES "mae_pages" ("id"),
...
CREATE TABLE "mae_pages" ("status" integer NOT NULL, "expiry_date" datetime, "updated" datetime NULL, "_order" integer, "titles" varchar(1000), "description" text NOT NULL, "title" varchar(500) NOT NULL, "short_url" varchar(200), "login_required" bool NOT NULL, "site_id" integer NOT NULL, "keywords_string" varchar(500) NOT NULL, "_meta_title" varchar(500), "parent_id" integer, "in_sitemap" bool NOT NULL DEFAULT 1, "publish_date" datetime, "created" datetime, "id" integer PRIMARY KEY AUTOINCREMENT, "content_model" varchar(50), "in_menus" varchar(100), "slug" varchar(2000), "gen_description" bool NOT NULL, format_type references mae_content_format_types(id));
...
INSERT INTO "sqlite_sequence" VALUES('mae_posts',362);
INSERT INTO "sqlite_sequence" VALUES('mae_content_format_types',2);
INSERT INTO "sqlite_sequence" VALUES('mae_pages',34);
